...
.PHONY: lint test test-core test-transaction test-audit test-package test-lifecycle test-site test-modules

lint:
	bash tools/lint.sh

test: test-core test-transaction test-audit test-package test-lifecycle test-site test-modules
